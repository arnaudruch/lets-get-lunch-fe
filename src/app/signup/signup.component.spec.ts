...
describe('SignupComponent', () => {
  ...
  it('should display an error message with invalid credentials', () => {
    ...
    signupPage.passwordInput.value = 'pwd';
    signupPage.usernameInput.dispatchEvent(new Event('input'));
    signupPage.passwordInput.dispatchEvent(new Event('input'));
    ...
    spyOn(authService, 'signup').and.callFake(() => {
      return Observable.throw({
        error: {
          message: 'Your passord must be at least 5 characters long.'
        }
      });
    });
    signupPage.submitBtn.nativeElement.click();
    ...
    expect (errorMessage.nativeElement.textContent).toEqual('Your passord must be at least 5 characters long.');
